...
class BoomiDataHubClient:
    ...
    Supports dual credentials for API access vs DataHub record queries.
    """
    ...
    # NEW: Parameterised Query Methods with Enhanced Field Mapping
...
def main():
    ...
    try:
        ...
        print("Boomi DataHub REST API Client with Enhanced Query Support")
        print("=" * 60)
